...
if (NOT LLVM_FOUND)
  ...
  find_path (LLVM_INCLUDES llvm/LinkAllVMCore.h
  ...
  find_library (LLVM_LIBRARIES LLVMCore LLVMAnalysis
    HINTS ${LLVM_ROOT_DIR}${CMAKE_INSTALL_PREFIX}
    PATH_SUFFIXES lib
    )
  ...
  if (LLVM_INCLUDES AND LLVM_LIBRARIES)
    set (LLVM_FOUND TRUE)
  else (LLVM_INCLUDES AND LLVM_LIBRARIES)
    set (LLVM_FOUND FALSE)
    if (NOT LLVM_FIND_QUIETLY)
      if (NOT LLVM_INCLUDES)
	message (STATUS "Unable to find LLVM header files!")
      endif (NOT LLVM_INCLUDES)
      if (NOT LLVM_LIBRARIES)
	message (STATUS "Unable to find LLVM library files!")
      endif (NOT LLVM_LIBRARIES)
    endif (NOT LLVM_FIND_QUIETLY)
  endif (LLVM_INCLUDES AND LLVM_LIBRARIES)
